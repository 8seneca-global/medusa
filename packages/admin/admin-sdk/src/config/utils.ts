import type { CustomFieldModelFormMap } from "@8medusa/admin-shared"
 ...
 * @example
 * ```ts
 * import { unstable_createFormHelper, unstable_defineCustomFieldsConfig } from "@8medusa/admin-sdk"
