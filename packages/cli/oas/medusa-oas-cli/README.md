...
`yarn add --dev @8medusa/medusa-oas-cli`

Install in the global namespace is not yet supported.
~~`npm install -g @8medusa/medusa-oas-cli`~~
...
This command will scan the `@8medusa/medusa` package in order to extract JSDoc OAS into a json file.
