import { SearchTypes } from "@8medusa/types"
 ...
 *  from the `@8medusa/utils` package.
 *
 ...
 * import { AbstractSearchService } from "@8medusa/utils"
 *
  ...
  implements SearchTypes.ISearchService
{
   ...
   * @example
   * // ...
   * import { ProductService } from "@8medusa/medusa"
   *
